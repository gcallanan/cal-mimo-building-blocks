...
streamblocks vivado-hls --set experimental-network-elaboration=on --set bypass-AM-generation=on --source-path matrix_mult_systolic.cal --target-path myproject mat_mul.Top
